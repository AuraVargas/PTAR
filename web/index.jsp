...
<html lang="en">
    <head>
        <title>PTAR EL SALITRE</title><link rel="shorcut icon" href="assets/img/ICONO.png" type="image/x-icon">
        <meta charset="utf-8">
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
            <img class="logo" src="assets/img/ICONOB.png" style="position: absolute; left: 1%">
        ...
        <section class="ftco-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="project">
                            <div class="img rounded mb-4" style="background-image: url(assets/img/staff-6.jpg);"></div>
                            <div class="text w-100 text-center">
