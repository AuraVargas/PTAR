    ...
    <body class="tres">
        ...
        <header class="menu">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" id="informacion" href="#"><img class="logo" src="assets/img/ICONO.png" alt=""/>
                        ...
                        <div class="form-row">
                            ...
                            <div class="container-login100-form-btn">
                                <button onclick="validacion()" class="login100-form-btn" type="submit" name="accion" value="Registrar">
                                 ...
                                 <div class="container-login100-form-btn">
                                <a class="login11-form-btn" onclick="return cancelarregistroV()"> Cancelar</a>
                            </div>
                            </div>
                        </div>
                    </form>
